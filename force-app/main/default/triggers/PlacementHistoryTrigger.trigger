trigger PlacementHistoryTrigger on Placement_History__c (before insert,before update, after insert, before delete, after update) { 
    ...
    if(runTrigger){
        ...
        if(PlacementHistoryTriggerHandler.runPlacementHistoryTrigger == true){
            ...
            if(Trigger.isAfter){
                if(Trigger.isInsert){
                    PlacementHistoryTriggerHandler.handleAfterInsert(Trigger.new);
                }
            }
        }
    }
